...
const ReaderInfo = () => {
  ...
  const handleClick = (id) => {
    ...
    }else if (readerName === "عمر القزابري") {
      setAudioScource(`https://server9.mp3quran.net/omar_warsh/${numberOfSurah}.mp3`);
    }
    else if (readerName === "ناصر القطامي") {
      setAudioScource(`https://server6.mp3quran.net/qtm/${numberOfSurah}.mp3`);
    }
  };
